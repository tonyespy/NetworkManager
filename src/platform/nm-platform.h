...
typedef struct {
	...
	gboolean (*link_get_kernel_ipv6ll_addr_enabled) (NMPlatform *, int ifindex);
	gboolean (*link_set_kernel_ipv6ll_addr_enabled) (NMPlatform *, int ifindex, gboolean enabled);
	...
	gboolean (*check_support_kernel_ipv6ll_addr_disable) (NMPlatform *);
} NMPlatformClass;
...
gboolean nm_platform_link_get_kernel_ipv6ll_addr_enabled (int ifindex);
gboolean nm_platform_link_set_kernel_ipv6ll_addr_enabled (int ifindex, gboolean enabled);
...
gboolean nm_platform_check_support_kernel_ipv6ll_addr_disable (void);
