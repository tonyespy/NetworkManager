...
main (int argc, char *argv[])
{
	...
	if (global_opt.slaac) {
		...
		rdisc = nm_lndp_rdisc_new (nm_netns_get_platform (nm_netns_controller_get_root_netns ()), ifindex, global_opt.ifname, global_opt.uuid, global_opt.addr_gen_mode, NULL);
		g_assert (rdisc);
