...
static void
_modprobe_child_setup (gpointer user_data G_GNUC_UNUSED)
{
...
#define ARGV_TO_STR(argv)   (_log_str ? _log_str : (_log_str = g_strjoinv (" ", (char **) argv->pdata)))
	...
	if (!g_spawn_sync (NULL, (char **) argv->pdata, NULL, 0, _modprobe_child_setup, NULL, NULL, NULL, &exit_status, &local)) {
