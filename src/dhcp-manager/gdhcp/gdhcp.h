...
void g_dhcp_client_stop(GDHCPClient *client, gboolean release);
...
GDHCPType g_dhcp_client_get_type (GDHCPClient *client);
...
int g_dhcpv6_client_set_duid(GDHCPClient *dhcp_client, const unsigned char *duid,
			int duid_len);
const unsigned char *g_dhcpv6_client_get_client_duid(GDHCPClient *dhcp_client, int *out_len);
const unsigned char *g_dhcpv6_client_get_server_duid(GDHCPClient *dhcp_client, int *out_len);
...
int g_dhcpv6_client_get_timeouts(GDHCPClient *dhcp_client,
				...
				gint32 *started, uint32_t *preferred, uint32_t *expire);
