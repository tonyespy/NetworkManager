...
NmcOutputField nmc_fields_setting_ip6_config[] = {
	...
	SETTING_FIELD (NM_SETTING_IP6_CONFIG_ADDR_GEN_MODE, 15),          /* 14 */
	SETTING_FIELD (NM_SETTING_IP_CONFIG_DHCP_SEND_HOSTNAME, 19),      /* 15 */
	SETTING_FIELD (NM_SETTING_IP_CONFIG_DHCP_HOSTNAME, 14),           /* 16 */
	{NULL, NULL, 0, NULL, FALSE, FALSE, 0}
};
